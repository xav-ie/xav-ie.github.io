...
const longTermProjects: ProjectData[] = [
  {
    name: 'Tabby',
    ...
    <>
      <div id="projects" className="section">
        ...
        <ul className="row no-bullets">
          {longTermProjects.map((p) => <Project key={p.name} project={p} />)}
        </ul>
      </div>
